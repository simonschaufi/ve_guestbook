...
class tx_veguestbook_pi1 extends AbstractPlugin
{
    ...
    protected function sendNotificationMail($emailto)
    {
        ...
        $markerArray['###URL###'] = GeneralUtility::getIndpEnv('TYPO3_SITE_URL') . $this->getUrl($this->config['guestbook']);
        ...
        if (is_array($this->postvars)) {
            ...
            $mailer->setTo($emailto)
                ...
                ->setSender($emailfrom, $this->getEmailFromName())
                ->setReplyTo($emailfrom)
                ->setBody($notification_mail_text)
                ;
